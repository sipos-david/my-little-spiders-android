...
import dev.shipi.mylittlespiders.data.network.client.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth = when (authName) {
                "api_key" -> ApiKeyAuth("header", "Api-Key")
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "dev.shipi.mylittlespiders.data.network.client.baseUrl"
